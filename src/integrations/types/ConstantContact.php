...
class ConstantContact extends AbstractIntegrationType implements MailingListTypeInterface
{
     ...
     */
    public function setApiKey(string $apiKey = null): ConstantContact
    {
        $this->apiKey = $apiKey;
     ...
     * @return ConstantContact
     */
    public function setSecret(string $secret = null): ConstantContact
    {
        $this->secret = $secret;
     ...
     * @return ConstantContact
     */
    public function setAccessToken(string $accessToken = null): ConstantContact
    {
     ...
     * @return ConstantContact
     */
    public function setRefreshToken(string $refreshToken = null): ConstantContact
    {
