...
class FileUploadDecorator extends AbstractTranslatableDecorator
{
     ...
     * @param FileTypeProviderInterface $fileTypeProvider
     * @param FileUploadInterface       $fileUploadProvider
     */
    ...
    /**
     * @param FormCompileTagAttributesEvent $event
     */
